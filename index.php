...
<body>
    ...
    <main>
        ...
        <div class="total">
            <p>Total : <span></span> €</p>
            <a href="views/archive.php">Produits achetés <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="rgb(43, 43, 43)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h13M12 5l7 7-7 7"/></svg></a>
        </div>
        <div class="card-grid">
            <?php $products->displayProducts("products"); ?>
        </div>
    </main>
